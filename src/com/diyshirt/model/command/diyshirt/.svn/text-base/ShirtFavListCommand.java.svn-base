...
public class ShirtFavListCommand extends Command{
	static org.apache.log4j.Logger logger = Logger.getLogger();

	public String getName() {
		return CommandFactory.DIYSHIRTFAVLIST;
	}
	...
	public Object execute(HttpServletRequest request,
		...
		Page page=ShirtManager.getInstance().findshirtfav(pageNum,10,UserID);
		request.setAttribute("page", page);
		
		resultPage = ApplicationResources.DIYSHIRT_DIYSHIRTFAVLIST;
