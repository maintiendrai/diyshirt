...
<body>
<form id="form" name="checkform" method="post" action="FrontController.do?operation=ordersdelete" onSubmit="return jscheckform(checkform)">
				...
				<tr>
					...
					<td>
						<table border=0 cellspacing=0 cellpadding=0 width="98%" class="small">
                            ...
                            <tr><td><br></td></tr>
                            <tr>
                                <td align="center" colspan="2"><input type="submit" name="sub" value="确认撤消">
