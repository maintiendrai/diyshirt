	...
	<tr>
        ...
        <%
         ...
         %>
	        ...
	        %>
	        <a href='messageList.do?operation=messagelist&pageNum=1&method=user&pageLength=<%=mypage.getPageLength() %>'>首页</a>&nbsp;&nbsp;
	        <a href='messageList.do?operation=messagelist&method=user&pageNum=<%=mypage.getPageNum()-1 %>&pageLength=<%=mypage.getPageLength() %>'>上页</a>&nbsp;&nbsp;
	        <%
	        }%>
        	...
        	<%
                    	...
                    	%>
        	<a href='messageList.do?operation=messagelist&method=user&pageNum=<%=mypage.getPageNum()+1 %>&pageLength=<%=mypage.getPageLength() %>'>下页</a>&nbsp;&nbsp;
	        <a href='messageList.do?operation=messagelist&method=user&pageNum=<%=mypage.getPageCount() %>&pageLength=<%=mypage.getPageLength() %>'>末页</a>
	        <%
	        }}
	        %> 
