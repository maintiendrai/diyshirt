...
<title>会员管理</title>
  ...
  <body>
   ...
   <form id="form" name="form" method="post" action="FrontController.do?operation=userdel">
   ...
   <table border=0 cellspacing=0 cellpadding=0 width="98%" class="small">
	...
	<tr> 
		<td colspan="2"  class="dvInnerHeader"><b>会员删除</b></td>
...
<table border=0 cellspacing=0 cellpadding=0 width="98%" class="small">
    <tr>
        <td align="center" colspan="4"><input type="submit" name="sub" value="确认删除">
