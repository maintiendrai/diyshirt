...
<title>会员管理</title>
  ...
  <body>
   ...
   <form id="form" name="form" method="post" action="FrontController.do?operation=userfreeze">
   ...
   <table border=0 cellspacing=0 cellpadding=0 width="98%" class="small">
	...
	<tr> 
		<td colspan="2"  class="dvInnerHeader"><b>会员状态修改</b></td>
...
<table border=0 cellspacing=0 cellpadding=0 width="98%" class="small">
    <tr>
      ...
      <td ><input type="hidden" name="UserID" value="<%=to.getUserID()%>"/><%=to.getUserID()%></td>
    </tr>
    <tr>
      <td>状态</td>
      <td>
          <select name="Status">
    			...
    			<option value="1" <%if(to.getStatus()==1) out.print("selected");%>>冻结</option>
  	      </select>
      </td>
    </tr>
    <tr>
...
<table border=0 cellspacing=0 cellpadding=0 width="98%" class="small">
    <tr>
        <td align="center" colspan="4"><input type="submit" name="sub" value="确认修改">
